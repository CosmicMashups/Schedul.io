...
interface ToastItem { id: number; message: string; tone: 'success' | 'error'; leaving: boolean; }
interface ToastContextValue { show: (message: string, tone?: 'success' | 'error') => void; }
